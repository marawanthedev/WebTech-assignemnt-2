...
await fileRef.put(file);
  ...
  <input type="file" id="real-file" hidden="hidden"   onChange={(e)=>handleChanges(e.target.files)}/>
<button type="button" id="custom-button" onClick={()=>document.querySelector("#real-file").click()}>CHOOSE A FILE</button>
